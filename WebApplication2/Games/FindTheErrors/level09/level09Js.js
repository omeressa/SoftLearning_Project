...
function correct001() {
    ...
    audio.play();
    board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - x undeclared in this scope</h3>";
    score001.innerHTML = a++;
    if (a > 0) {
        message002.innerHTML = "<button class=blue001 onclick=nextLevel()>Next Level</button>";
        board001.innerHTML = "<img src=../Capture19.PNG height=307 width=337 />";
        board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - x undeclared in this scope</h3>";
    }
}
...
function nextLevel() {
    window.location = "../level091/level091.html";
}