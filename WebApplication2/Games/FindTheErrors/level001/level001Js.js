...
function correct001() {
    ...
    audio.play();
    board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - missing initialization statement</h3>";
    score001.innerHTML = a++;
    if (a > 0) {
        message002.innerHTML = "<button class=blue001 onclick=nextLevel()>Next Level</button>";
        board001.innerHTML = "<img src=../Capture16.PNG height=266 width=286 />";
        board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - missing initialization statement</h3>";
    }
}
...
function nextLevel() {
    window.location = "../level002/level002.html";
}