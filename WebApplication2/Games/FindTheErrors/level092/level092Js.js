...
function correct001() {
    ...
    audio.play();
    board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - m is called before it is declared</h3>";
    score001.innerHTML = a++;
    if (a > 0) {
        message002.innerHTML = "<button class=blue001 onclick=nextLevel()>Next Level</button>";
        board001.innerHTML = "<img src=../Capture21.PNG height=344 width=327 />";
        board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - m is called before it is declared</h3>";
    }
}
...
function nextLevel() {
    window.location = "../level093/level093.html";
}