...
function correct001() {
    ...
    audio.play();
    board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - called object ‘function_pointer’ is not a function or function pointer</h3>";
    score001.innerHTML = a++;
    if (a > 0) {
        message002.innerHTML = "<button class=blue001 onclick=nextLevel()>Next Level</button>";
        board001.innerHTML = "<img src=../Capture24.PNG height=456 width=663 />";
        board001.innerHTML += "<div id=mark001></div><h3 id='text1'>compilation error - called object ‘function_pointer’ is not a function or function pointer</h3>";
    }
}
